---
description: Display
title: 18.5inch Touch Monitor
keywords:
- RK3566 CM4 Serial
image: https://files.luckfox.com/wiki/Display
slug: /Display/18.5inch-Touch-Monitor
sidebar_position: 15
last_update:
  date: 06/12/2025
  author: Rain
...
2. Connect the Type-C cable to the Raspberry Pi and the touch port of the LCD.
3. Connect the HDMI interface of the LCD to the HDMI interface of the Raspberry Pi, power on the Raspberry Pi. After waiting for a few seconds, the LCD will display and touch normally.
## 6. Using with PC

Supports PC version of Windows 11 / 10 / 8.1 / 8 / 7 system.

1. Connect the 5V 3A power adapter to the power port of the LCD.
2. Connect the Type-C cable to the PC and the touch port of the LCD.
3. Connect the HDMI interface of the LCD to the HDMI interface of the PC. After waiting for a few seconds, the LCD will display and touch normally.
...
## 8. Dimensions<br/>![](./photo/18.5inch-Touch-Monitor/18.5inch-Touch-Monitor-details-size.jpg)
