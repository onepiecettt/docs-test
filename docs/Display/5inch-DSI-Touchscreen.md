...
5" DSI Touchscreen is a capacitive touchscreen with a resolution of 800x480 and a wide viewing angle of 160°. It supports multiple operating systems and requires no driver installation, making it suitable for various application needs.

## 2. Product parameters

| **Project**        | **Describe**        | **Unit** |
| ------------------ | ------------------- | -------- |
| Model              | 5'' DSI Touchscreen | /        |
| Size               | 5.0                 | Inch     |
| Viewing Angle      | 160                 | Deg      |
| Resolution         | 800x480             | Pixels   |
| Product Size       | 120.70(H)×77.20(V)  | mm       |
| Display Area       | 109.00(H)×65.80(V)  | mm       |
| Color Gamut        | 50%                 | NTSC     |
| Maximum Brightness | 280                 | cd/m²    |
| Constrast          | 1000:1              | /        |
...
1. Use an FFC cable to connect the 5inch DSI LCD to the 15-pin DSI interface on the Raspberry Pi board.<br/>
2. For convenience, you can secure the Raspberry Pi board to the back of the 5inch DSI LCD using screws and assemble the standoffs, as shown in the image below:<br/>![](./photo/5inch-DSI-Touchscreen/5DSI_touchscreen01.png)
...
1. Open "Screen Configuration" application:<br/>![](photo/5inch-DSI-Touchscreen/7DSI_touchscreen05.png)

2. Go to "Screen"->"DSI-1"->"Touchscreen", check "6-0038 generic ft5x06(79)"<br/>![](photo/5inch-DSI-Touchscreen/7DSI_touchscreen06.png)

3. Click “Apply” and close the current window. Reboot according to the pop-up prompts, then the touchscreen selection is complete.<br/>![](photo/5inch-DSI-Touchscreen/7DSI_touchscreen07.png)<br/>![](photo/5inch-DSI-Touchscreen/7DSI_touchscreen08.png)

4. Go to "Screen" -> "DSI-1" -> "Orientation," check the direction you want to rotate, and finally click "Apply" to complete the synchronized rotation of the display and touch.<br/>![](./photo/5inch-DSI-Touchscreen/7DSI_touchscreen09.png)
...
1. Open "Screen Configuration" application:<br/>![](./photo/5inch-DSI-Touchscreen/7DSI_touchscreen10.png)

2. Go to "Screen"->"DSI-1"->"Orientation", select the rotation direction, and then click on "Apply".<br/>![](./photo/5inch-DSI-Touchscreen/7DSI_touchscreen11.png)<br/>![](./photo/5inch-DSI-Touchscreen/7DSI_touchscreen12.png)
...
## Resource
### Drawing
- [5' DSI Touchscreen 3D Drawing](https://files.luckfox.com/wiki/Display/draw/5inch-dsi-touchscreen.rar)
