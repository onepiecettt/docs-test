...
slug: /Display/7inch-DSI-TOUCH-A
sidebar_position: 7
last_update:
  date: 04/02/2024
  author: Rain
...
## Product Features  
- 7-inch DSI touch screen, capacitive 10-point touch control  
...
- AF anti-fingerprint coating, resistant to fingerprints and easy to clean  
...
**Note 1**: Input voltage exceeding the maximum or improper operation may cause permanent damage to the device.  
**Note 2**: Input current must be ≥0.5A, otherwise it may cause boot failure or abnormal display. Long-term abnormal operation may cause permanent damage to the device.  
...
## Interface Introduction <br/>![](./photo/7-DSI-TOUCH-A/7-DSI-TOUCH-A-details-11.jpg)
...
**Installation Effect:**  <br/>![](./photo/7-DSI-TOUCH-A/7-DSI-TOUCH-A-details-3.jpg)  
...
2. Use the "GPIO cable" to connect the power connector of the display to the 5V GND pin header of the Raspberry Pi motherboard. <br/>![](./photo/7-DSI-TOUCH-A/Gpio-connection.png) 
3. Secure the Raspberry Pi to the display with M2.5 screws.
**Installation Effect:**  <br/>![](./photo/7-DSI-TOUCH-A/7-DSI-TOUCH-A-details-3-1.jpg)
...
[7-DSI-TOUCH-A Pre-installed Image](https://drive.google.com/file/d/1pVgPu44XyRq5INNHo1J57mXx5rwJYDkX/view?usp=sharing ) 
...
1. Open the "Screen Configuration" application.  <br/>![](./photo/7inch-DSI-Touchscreen/7DSI_touchscreen05.png)<br/>
2. Navigate to "Screen" -> "DSI-1" -> "Touchscreen", and check the option "10-0014 Goodix Capacitive TouchScreen".  <br/>![](./photo/7inch-DSI-Touchscreen/7DSI_touchscreen06.png)<br/>
3. Click "Apply", then close the window. Follow the popup prompt to reboot the system. This completes the touchscreen assignment.<br/>![](./photo/7inch-DSI-Touchscreen/7DSI_touchscreen07.png)<br/>![](./photo/7inch-DSI-Touchscreen/7DSI_touchscreen08.png)<br/>
4. Navigate to "Screen" -> "DSI-1" -> "Orientation", select the desired rotation direction, then click "Apply". Both display and touch orientation will now be synchronized.<br/>![](./photo/7inch-DSI-Touchscreen/7DSI_touchscreen09.png)<br/>
...
<br/>You can also permanently set the display or hide the screen keyboard through the "Display" option under "Raspberry Pi Configuration" or through the "Display" section in raspi-config.<br/>![](./photo/7-DSI-TOUCH-A/DSI-Touch-Bookworm-Keyboard-02.png)
...
```
## ESP32-P4 
### Display Driver <br/>![](./photo/7-DSI-TOUCH-A/900px-101M_8001280_IPS_CT_K_ESP32_P4.jpg)

The ESP32-P4-NANO drives the screen via MIPI 2-lane.<br/>![](./photo/7-DSI-TOUCH-A/900px-ESP32-P4-Nano-ETH_to_WiFi_240925_02.png)  

1. The screen driver has been packaged as a component, available on the [ESP Component Registry](https://components.espressif.com/components/waveshare/esp_lcd_ili9881c)
...
```
<br/>![](./photo/7-DSI-TOUCH-A/ESP32-P4-Nano-I2C_240906_01.png)  

## Resources
### 2D Drawing

- [7-DSI-TOUCH-A-DWG Drawing](https://files.waveshare.com/wiki/7-DSI-TOUCH-A/7-DSI-Touch-A-Size.dwg)
- [7-DSI-TOUCH-A-PDF Drawing](https://files.waveshare.com/wiki/7-DSI-TOUCH-A/7-DSI-Touch-A-Size.pdf)
