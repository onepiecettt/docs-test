...
<div id="luckfox_model_mark" style={{display:'none'}}>15.6″ Portable Monitor</div>

## 1. 介绍

15.6″ Portable Monitor是一款具有1920×1080分辨率、100% sRGB 高色域的 IPS 面板显示屏，提供178°广角视角，自带固定75mm的M4 VESA孔位，节省安装空间，并且兼容大多数标准HDMI设备，满足各种应用需求。

## 2. 产品参数

| **项目** | **描述**                | **单位** |
| -------- | ----------------------- | -------- |
| 产品型号 | 15.6″ Portable Monitor  | /        |
| 尺寸     | 15.6                    | Inch     |
| 可视角度 | 178                     | Deg      |
| 分辨率   | 1920 × 1080             | Pixels   |
| 产品尺寸 | 355.51 (H) × 221.47 (V) | mm       |
| 显示区域 | 344.16 (H) × 193.59 (V) | mm       |
| 色域     | 100%                    | sRGB     |
| 最大亮度 | 300                     | cd/m²    |
| 对比度   | 1000:1                  | /        |
| 背光调节 | OSD菜单调节             | /        |
...
![](./photo/15.6inch-Portable-Monitor/15.6inch-Portable-Monitor-details-size.jpg)
