...
18.5″便携式显示器，采用1920×1080全高清分辨率的100% sRGB高色域IPS面板，呈现细腻丰富的色彩，支持178°超广视角与最高120Hz刷新率，画面流畅自然。配备10点电容式触控，支持多指操作，触控响应灵敏。机身带有标准75mm M4 VESA安装孔，便于灵活安装与空间优化，兼容各类标准HDMI设备，广泛适用于多种应用场景。
...
1. 将5V 3A电源适配器连接到LCD的电源接口。
2. 将 Type-C线连接到树莓派和屏幕的触摸接口。
3. 将LCD的HDMI接口连接到树莓派的HDMI接口，给树莓派上电，稍等片刻，即可正常显示触摸。

## 6. 搭配PC机使用
支持PC版Windows 11 / 10 / 8.1 / 8 / 7系统。

1. 将5V 3A电源适配器连接到LCD的电源接口。
2. 将 Type-C线连接到PC和LCD的触摸接口。
3. 将LCD的HDMI接口连接到PC机的HDMI接口，大约等待几秒钟后，LCD正常显示触摸。 
...
## 8. 外观尺寸<br/>![](./photo/18.5inch-Touch-Monitor/18.5inch-Touch-Monitor-details-size.jpg)
