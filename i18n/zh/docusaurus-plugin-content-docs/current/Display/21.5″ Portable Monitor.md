...
<div id="luckfox_model_mark" style={{display:'none'}}>21.5″ Portable Monitor</div>
...
## 3.接口说明<br/>![](./photo/21.5inch-Portable-Monitor/21.5inch-Portable-Monitor-details-35.jpg)
...
## 8. 外观尺寸<br/>![](./photo/21.5inch-Portable-Monitor/21.5inch-Portable-Monitor-details-size.jpg)
...
- 在“选择显示器”下拉菜单中，选择 21.5" 便携显示器，点击显示适配器属性。<br/>![](./photo/18.5inch-Portable-Monitor/18.5inch_Portable_Monitor_FAQ_2.png)
