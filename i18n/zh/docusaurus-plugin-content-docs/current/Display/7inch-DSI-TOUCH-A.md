...
<div id="luckfox_model_mark" style={{display:'none'}}>7-DSI-TOUCH-A</div>
...
## 接口简介<br/>![](./photo/7-DSI-TOUCH-A/7-DSI-TOUCH-A-details-11.jpg)
...
**安装效果如下：**  <br/>![](./photo/7-DSI-TOUCH-A/7-DSI-TOUCH-A-details-3.jpg)  
...
2. 使用"GPIO 连接线"，将显示屏的电源接口连接到树莓派主板的5V GND排针。<br/>![](./photo/7-DSI-TOUCH-A/Gpio-connection.png) 
3. 用M2.5螺丝将树莓派固定到显示屏上。
**安装效果如下：**  <br/>![](./photo/7-DSI-TOUCH-A/7-DSI-TOUCH-A-details-3-1.jpg)
...
1. 选择预安装镜像，下载并解压为.img文件  
    [7-DSI-TOUCH-A预安装镜像](https://pan.baidu.com/s/1xghnsViBh54jn_dc_MzDsg?pwd=wsdz )  
...
2. 使用2PIN电源连接线，将显示屏的电源接口连接到Omni3576主板的40PIN GPIO接口。如下图所示：<br/>![](./photo/7-DSI-TOUCH-A/101M_8001280_IPS_CT_K_Omni3576.jpg)
...
```
## ESP32-P4 使用说明
### 屏幕驱动<br/>![](./photo/7-DSI-TOUCH-A/900px-101M_8001280_IPS_CT_K_ESP32_P4.jpg)

ESP32-P4-NANO通过`MIPI 2-lane`驱动该屏幕。<br/>![](./photo/7-DSI-TOUCH-A/900px-ESP32-P4-Nano-ETH_to_WiFi_240925_02.png)  

1. 此屏幕驱动已封装为组件，组件位置位于[ESP Component Registry](https://components.espressif.com/components/waveshare/esp_lcd_ili9881c)
   使用`idf.py add-dependency "waveshare/esp_lcd_ili9881c"`来向你的ESP-IDF工程中添加组件。
...
- [7-DSI-TOUCH-A-DWG图纸](https://www.waveshare.net/w/upload/0/0e/7-DSI-Touch-A-Size.dwg)
- [7-DSI-TOUCH-A-PDF图纸](https://www.waveshare.net/w/upload/2/20/7-DSI-Touch-A-Size.pdf)
